...
public class assassinSkill1 extends activeSkill{
	...
	public assassinSkill1() {
		...
		if (this.skillLevel==0) {
			...
			this.skillDesc = "½ş¶¾ÎäÆ÷: 4»ØºÏ³ÖĞøÉËº¦M_ATK*1¡£ÀäÈ´4¡£Ä§ºÄ10";
			this.coldTime = 4;
			this.magicCost = 10;
			this.damageRatio = 1;
			this.lastTime = 4;
		}else if (this.skillLevel==2) {
			this.skillDesc = "½ş¶¾ÎäÆ÷: 4»ØºÏ³ÖĞøÉËº¦M_ATK*2¡£ÀäÈ´4¡£Ä§ºÄ20";
			this.coldTime = 4;
			this.magicCost = 20;
			this.damageRatio = 2;
			this.lastTime = 4;
		}else if (this.skillLevel==3) {
			this.skillDesc = "½ş¶¾ÎäÆ÷: 4»ØºÏ³ÖĞøÉËº¦M_ATK*3¡£ÀäÈ´4¡£Ä§ºÄ30";
			this.coldTime = 4;
			this.magicCost = 30;
			this.damageRatio = 3;
			this.lastTime = 4;
